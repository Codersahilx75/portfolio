...
const services = [
  {
    ...
    bgColor: "rgba(34,197,94,0.3)", // darker green
  },
  {
    ...
    bgColor: "rgba(251,146,60,0.3)", // darker orange
  },
  {
    ...
    bgColor: "rgba(234,179,8,0.3)", // darker yellow
  },
  {
    ...
    bgColor: "rgba(129,140,248,0.3)", // darker indigo
  },
  {
    icon: <FaServer className="text-gray-700 dark:text-gray-300 text-4xl" />,
    title: "Backend Development",
    description:
      "Building robust backend systems using Node.js, Express, and other technologies to power your applications.",
    bgColor: "rgba(107,114,128,0.3)", // darker gray
  },
  {
    icon: <FaJsSquare className="text-yellow-400 text-4xl" />,
    title: "JavaScript Technologies",
    description:
      "Proficiency in JavaScript, including ES6+, Node.js, React, and modern tooling for full-stack development.",
    bgColor: "rgba(253,224,71,0.3)", // darker light yellow
  },
];
...
function Services() {
  return (
    <section
      id="services"
      className="bg-[#f8f9ff] dark:bg-[#0b0f1a] py-20 px-4 transition-colors duration-300"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {services.map((service, index) => (
            <div
              key={index}
              className="service-card rounded-2xl shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl bg-white dark:bg-[#111827]"
              style={{ "--hover-bg": service.bgColor }}
            >
              <div className="content p-6">
                <div className="mb-5 transition-transform duration-300 group-hover:scale-110">
                  <div className="w-16 h-16 flex items-center justify-center bg-gray-100 dark:bg-[#1f2937] rounded-full icon-wrapper">
                    {service.icon}
                  </div>
                </div>
